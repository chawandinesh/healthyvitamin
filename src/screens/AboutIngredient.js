    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.goBack()}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('HomeScreen')}>
          <AntDesign name="home" style={{color: '#fff', fontSize: 40}} />
        </TouchableOpacity>
          </View>
        <Text style={styles.headerText}>{data.name}</Text>
      </View>
      <View style={{marginTop: height * 0.2}}>
          <Image source={data.image} style={{height: height * 0.25, width: width, borderWidth: 2}}  resizeMode="cover"/>
      </View>
      <View style={{marginTop: 20, padding: 5, height: height * 0.2, justifyContent:'center'}}>
